...
# SIB010 Sibir Controller
This describes the Z-Wave device *SIB010*, manufactured by *[Syneltec SA](http://www.syneltec.ch/)* with the thing type UID of ```syneltec_sib010_00_000```.

The SIB010 supports routing. This allows the device to communicate using other routing enabled devices as intermediate routers.  This device is also able to participate in the routing of data between other devices in the mesh network.

## Overview

Remotely Controlled Relay Switch ...

### Inclusion Information

Add Sibir Controller to the network by pushing three times key no 1.

### Exclusion Information

Remove Sibir Controller from the network by pushing three times key no 1. For toggle switch perform 3 position changes.
